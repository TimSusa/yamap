...
angular.module('yaMaps')
  .directive('map', ['$injector', function ($injector) {
    ...
    return {
      ...
      controller: function($scope, $element, $attrs) {
        ...
        $scope.wheelzoom = toDotNotation($scope, $attrs.wheelzoom);
        $scope.draggable = toDotNotation($scope, $attrs.draggable);
        ...
        if ($attrs.bounds) {
          $scope.$watch($attrs.bounds, function() {
            if ($scope.bounds) {
              $scope.bounds = $scope.helpers.toDotNotation($scope, $attrs.bounds);
              setViewBounds($scope.bounds);
            }
          });
        }

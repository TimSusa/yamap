  ...
  .directive('map', ['MapConfig', '$document', '$compile', function (MapConfig, $document, $compile) {
    return {
      ...
      controller: function($scope, $element, $attrs) {
        ...
        if ( !$attrs.zoom ) {
          $scope.zoom = $scope.mpc.helpers.useDotNotation($scope, $attrs.zoom);
          $scope.center = $scope.mpc.helpers.useDotNotation($scope, $attrs.center);
          $scope.bounds = $scope.mpc.helpers.useDotNotation($scope, $attrs.bounds);
          $scope.wheelzoom = $scope.mpc.helpers.useDotNotation($scope, $attrs.wheelzoom);
          $scope.draggable = $scope.mpc.helpers.useDotNotation($scope, $attrs.draggable);
        }
